...
exports.signUp = (req,res)=>{
   ...
   const noImg ="no-img.png"
    ...
    .get() //this prevent same userid being used twice//
    .then((doc)=>{
        if(doc.exists){
...
exports.login =(req,res)=>{ //logoin route
    const user={
        email: req.body.email,
        password: req.body.password
    };
...
exports.getUserDetails = (req, res) => {
    let userData = {};
    db
    .doc(`/user/${req.params.handle}`)
      .get()
      .then((doc) => {
        if (doc.exists) { //exists checks if user or doc exsists
